...
@pytest.mark.parametrize(
    ...
    [
        (
            {
                "INVENIO_RABBITMQ_USER": "testuser",
                "INVENIO_RABBITMQ_PASSWORD": "testpassword",
                "INVENIO_RABBITMQ_HOST": "testhost",
                "INVENIO_RABBITMQ_PORT": "5672",
                "INVENIO_RABBITMQ_PROTOCOL": "amqp",
                "INVENIO_RABBITMQ_VHOST": "/testvhost",
            },
...
@pytest.mark.parametrize(
    ...
    [
        (
            {
                "INVENIO_CACHE_REDIS_HOST": "testhost",
                "INVENIO_CACHE_REDIS_PORT": "6379",
                "INVENIO_CACHE_REDIS_PASSWORD": "testpassword",
                "INVENIO_CACHE_REDIS_PROTOCOL": "redis",
            },
            2,
        ...
        (
            {"INVENIO_CACHE_REDIS_URL": "redis://localhost:6379/3"},
            3,
